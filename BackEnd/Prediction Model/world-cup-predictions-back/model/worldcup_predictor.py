...
GROUPS = {'A': ['Qatar', 'Ecuador', 'Senegal', 'Netherlands'],
        ...
        'E': ['Spain', 'Germany', 'Costa Rica', 'Japan'],
...
sd = pd.read_csv('/home/brian/Desktop/world-cup-predictions-2018/world-cup-predictions-back/country_strength_test.csv').to_dict('records')
STRENGTH = sd[0]
...
def _simulate_round_robins(matches, defense, actuals):
    ...
    for key in GROUPS.keys():
        ...
        table.to_csv('group_phase.csv',mode='a',index=True,header=False)
