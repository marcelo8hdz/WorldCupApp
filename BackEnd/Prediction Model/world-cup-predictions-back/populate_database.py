...
def populate_teams(world_cup_predictions):
    ...
    credible_round_16 = advance_to_knockout(
        pass_group, pd.read_csv('/home/brian/Desktop/world-cup-predictions-2018/world-cup-predictions-back/records2.csv', index_col=0))
    index = 0
...
if not games or not teams or not groups:
    historical_matches = fetch_matches('/home/brian/Desktop/world-cup-predictions-2018/world-cup-predictions-back/resultsFinal.csv', threshold)
